...
const Account = () => {
    ...
    return (
        <div className='flex w-[80vw] sm:w-full justify-evenly items-center h-[70vh] p-10 mx-auto '>
            <div className='hidden sm:block '>
                <img src={maticHero} alt="" />
            </div>
            <div className='flex flex-col gap-10'>
                <h1 className='text-primary font-bold text-5xl md:text-6xl mb-5'>
                    gm @{account}
                </h1>

                <p className='text-xl text-thin '>
                    address <span className='input input-disabled bg-neutral p-x-5 py-2 ml-5 cursor-default '>{address} </span>
                </p>
                <p className='text-xl text-thin '>
                    Balance <span className='input py-2 input-disabled bg-neutral p-x-5 ml-5 cursor-default'>{balance}
                        <span className='bg-base-300 px-5 py-2  -mr-5 ml-2 rounded-r-lg'>MATIC </span>
                    </span>
                    <span className='input py-2 input-disabled bg-neutral p-x-5 ml-5 cursor-default'>{balance}
